...
/**
 * Defines a customizable field in the customer profile panel
 * These fields can be mapped to metadata variables for dynamic data display
 */
@Entity
@Table(name = "customer_profile_fields")
public class CustomerProfileField {
    @Id
    ...
    private Boolean isVisible = true; // Whether field is shown in profile
    
    @Column(name = "is_editable", nullable = false)
    private Boolean isEditable = false; // Whether field can be edited by agent
